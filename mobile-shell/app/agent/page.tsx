...
// This used to be an async Server Component doing the session/device-token
// check and site-list fetch inline before rendering (see git history /
    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .team-expand-toggle { flex-shrink: 0; padding: 3px 9px; border-radius: 999px; border: 1px solid #e2e8f0; background: #f8fafc; color: #64748b; font-size: 10.5px; font-weight: 700; transition: transform 0.15s; }
        ...
        .lead-status-badge.st-closed { background: #dcfce7; color: #15803d; }
        .lead-status-badge.st-lost { background: #fee2e2; color: #b91c1c; }
        .lead-actions-row { display: flex; align-items: center; gap: 8px; margin-top: 8px; }
        .lead-expand-toggle { padding: 3px 9px; border-radius: 999px; border: 1px solid #e2e8f0; background: #f8fafc; color: #64748b; font-size: 10.5px; font-weight: 700; transition: transform 0.15s; }
        .lead-expand-toggle.expanded { transform: rotate(90deg); }
        ...
        #contact-picker-modal-box { max-height:80vh; display:flex; flex-direction:column; }
        ...
        <div id="scroll-body">
          ...
          <div id="tab-home" className="tab-panel">
            <div className="home-grid">
              ...
              <button id="home-needs-action-box" className="home-box home-box-plain home-box-pending"></button>
      ...
      <script src="/agent-app.js?v=20260821a" suppressHydrationWarning />
